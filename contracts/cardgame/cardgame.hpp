...
class [[eosio::contract]] cardgame : public eosio::contract {
  ...
  private:
    ...
    // NOTE: The following random function is a simple example designed to be used in the game, however, it is inherently insecure. It is not advisable to use this in a Blockchain Application that requires equally distributed unpredictable numbers.
